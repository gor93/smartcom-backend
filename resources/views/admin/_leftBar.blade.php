...
<div class="menu-mobile menu-activated-on-click color-scheme-dark">
    <div class="mm-logo-buttons-w">
        <a class="mm-logo" href="index-2.html"><img src="{{ asset('assets/admin/img/logo.png') }}"><span>Clean Admin</span></a>
    ...
    <div class="menu-and-user">
        <div class="logged-user-w">
            <div class="avatar-w"><img alt="" src="{{ asset('assets/admin/img/avatar1.jpg') }}"></div>
        ...
        <ul class="main-menu">
            ...
            <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="apps_pipeline.html">Side &amp; Top Dark <strong
                                    class="badge badge-danger">New</strong></a></li>
                    <li><a href="apps_projects.html">Side &amp; Top <strong
                                    class="badge badge-danger">New</strong></a></li>
            ...
            <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="apps_pipeline.html">CRM Pipeline <strong
                                    class="badge badge-danger">New</strong></a></li>
            ...
            <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="front_home.html">Front Site <strong class="badge badge-danger">New</strong></a>
                    </li>
...
<div class="desktop-menu menu-side-w menu-activated-on-click">
    <div class="logo-w"><a class="logo" href="index-2.html"><img src="{{ asset('assets/admin/img/logo.png') }}"><span>Clean Admin</span></a>
    </div>
    <div class="menu-and-user">
        <div class="logged-user-w">
